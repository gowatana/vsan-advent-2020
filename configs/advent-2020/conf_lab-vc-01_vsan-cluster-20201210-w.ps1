...
$nest_cluster_name = "vsan-cluster-20201210-w"
$vm_num = 1
$hv_ip_4oct_start = 179 # 4th Octet for ESXi-vmk0-IP
...
# vSAN Datastore Name
$vsan_ds_name = "vsanDatastore-20201210-w"

# vSAN Disk Group type
$vsan_dg_type = "Hybrid" # Hybrid or AllFlash

# vSAN Disk setting
$vsan_cache_disk_size_gb = 300
$vsan_capacity_disk_size_gb = 10
