...
$nest_cluster_name = "vsan-cluster-20201210-b"
$vm_num = 2
$hv_ip_4oct_start = 173 # 4th Octet for ESXi-vmk0-IP
...
# vSAN Datastore Name
$vsan_ds_name = "vsanDatastore-20201210-b"
...
if($create_witness_vm -eq $true){
    $config_base = Split-Path -Path $PSScriptRoot -Parent
    $witness_config = "$config_base/witness/conf_Witness-VA_192.168.10.177.ps1"
